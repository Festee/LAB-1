...
<body>
    ...
    <div class="djathtas">
        ...
        <div class="njoftimi-input">
            <input type="text" placeholder="Shkruaj njoftimin...">
            <button id="plusi"><i class="fa-solid fa-plus"></i></button>
        </div>
        <b>NJOFTIMET E FUNDIT</b>
        <table>
            <tr>
              <td>•Kolona me e gjate me pak tekst</td>
              <td>
                <button id="update-btn"><i class="fa-solid fa-arrows-rotate"></i></button>
              </td>
              <td>
