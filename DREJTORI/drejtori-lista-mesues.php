...
<head>
    ...
    <title>Mesuesit</title>
    <link rel="stylesheet" href="drejtori-lista-mesues.css">
...
<body>
    ...
    <div class="djathtas">
        <h1 id="lista">Lista e mësuesve</h1>
        ...
        <?php
            ...
            <table id="mesues">
                ...
                <tr>
                  <td>ID:</td>
                  <td style="color: red; text-decoration: underline;"><?php echo $row['Mesuesi_ID']?></td>
                </tr>
                <tr>
                    <td>EMRI:</td>
                ...
                <tr>
                    <td>EMAIL:</td>
                    <td style="color: red; text-decoration: underline;"><?php echo $row['Email']?></td>
                </tr>
                <tr>
                    <td>NR.TEL:</td>
                ...
                <tr>
                    <td><a href="drejtori-edit-mesuesi.php?id=<?php echo $id;?>"><button id="update-btn"><i class="fa-solid fa-arrows-rotate"></i></button></a></td>
                    <td><a href="delete-mesuesi.php?id=<?php echo $id;?>"><button id="delete-btn"><i class="fa-solid fa-trash"></i></button></a></td>
                </tr>
                <?php
                   }
                    }
