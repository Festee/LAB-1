<?php
    ...
    if($db){
        $id=$_GET['id'];
        $qry="SELECT * from mesuesit where ID=$id ";
        $run=$db->query($qry);
        if($run->num_rows > 0){
...
<body>
    ...
    <div class="djathtas">
        ...
        <div class="container">
            <div class="left">
                <input type="text" value="<?php echo $mesuesi_id;?>" id="input1" placeholder="ID..." name="mesuesi_id">
                ...
                <input type="text" value="<?php echo $email;?>" id="input4" placeholder="Email..." name="email">
            ...
            <div class="right">
                ...
                <input style="width: 200px;" type="date" value="<?php echo $datelindja;?>" id="input7" placeholder="Data e lindjes..." name="datelindja">
        ...
        <button id="regjistro" type="update" name="update" value="Update">UPDATE</button>    
    </form>
    </div>
</body>
</html>
...
<?php
    if(isset($_POST['update'])){
        ...
        $qry="UPDATE mesuesit SET Emri='$emri',Mbiemri='$mbiemri', Email='$email',NrTel='$telefoni',Gjinia='$gjinia',Datelindja='$datelindja',Adresa='$adresa',LoginEmail='$login_email',LoginPassword='$login_password',Klasa='$klasa'  where ID='$id' ";

        if(mysqli_query($db,$qry)){
         echo '<script>alert("U ndryshu mesuesi!")</script>';
        }
    }
